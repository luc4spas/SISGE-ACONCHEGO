...
<div class="box">
        <div class="box-header with-border">
          ...
          <a href="{{ route('aluno.creat')}}" class="btn btn-primary" type="button"style="float:right"><i class="fa fa-plus"></i></a>
        ...
        <div class="box-body">
          <table class="table table-bordered">
            ...
            <tr>
              ...
              <td>{{ date( 'd/m/Y' , strtotime ($al->dta_nasc)) }}</td>
              <td>{{ $al->cel }}</td>
              <td>{{ date( 'd/m/Y' , strtotime ($al->dta_mat)) }}</td>
                ...
                <div style="display: inline;" class="dropdown">
                    <a  class="btn btn-info dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-print"></i></a>
                      ...
                      <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                        <a class="dropdown-item" href="{{action('AlunoController@ficha', $al['id'])}}" target="_blank" type="button">Ficha de requerimento</a>
                        <a class="dropdown-item" href="{{action('AlunoController@registro', $al['id'])}}" target="_blank" type="button">Ficha de registro</a><br>
                        <a class="dropdown-item" href="/storage/{{$al->amAl}}" target="_blank" type="button">Ficha de Anamnese</a>
                      </div>
                    </div>
                  </div>
                  <a href="{{action('AlunoController@edit', $al['id'])}}" type="button" class="btn btn-warning"><i class="fa fa-edit"></i></a>
                  <a href="{{action('AlunoController@edit', $al['id'])}}" type="button" class="btn btn-success"><i class="fa fa-phone  "></i></a>
              </td>
            </tr>
            @endforeach ()
            @endforeach ()
