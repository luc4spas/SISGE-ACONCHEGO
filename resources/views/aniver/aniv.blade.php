...
@section('content_header')
    ...
    <form class="form-inline" method="POST" role="search" action="{{ route('aniv.filtro') }}">
        {!! csrf_field() !!}
    ...
    <div class="col-lg-8 col-xs-6">
        <div class="box box-info collapsed-box">
            ...
            <div class="box-footer clearfix">
              <a class="btn btn-primary pull-right" type="button" href="{{ action('AniverController@filtro')}}" target="_blank"><i class="fa fa-print"></i></a>
            </div>
            <!-- /.box-footer -->
          </div>
    </div>
