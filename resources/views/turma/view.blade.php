          ...
          <td style="width 10px;width: 157px;">
            <div style="display: inline;" class="dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                ...
                <a class="dropdown-item" href="{{action('AlunoController@registro', [$aluno->id])}}" type="button">Ficha de registro</a> <br>
  ...
  <td style="width 8px;width: 90px;">
    <div style="display: inline;" class="dropdown">
      ...
      <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
        <a class="dropdown-item" href="{{action('AlunoController@ficha', [$aluno->id])}}" type="button">Ficha de requerimento</a>
        <a class="dropdown-item" href="{{action('AlunoController@registro', [$aluno->id])}}" type="button">Ficha de registro</a> <br>
        <a class="dropdown-item" href="{{action('AlunoController@showBoleto', $aluno['id'])}}" target="_blank" type="button">Boleto</a>
